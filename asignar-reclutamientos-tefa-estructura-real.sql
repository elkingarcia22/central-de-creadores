-- ====================================
-- ASIGNAR RECLUTAMIENTOS A TEFA (ESTRUCTURA REAL)
-- ====================================
...
-- 2. Verificar reclutamientos disponibles (sin reclutador asignado)
...
-- 3. Asignar a tefa como reclutador en varios reclutamientos
...
SELECT 
    ...
    r.fecha_sesion,
    CASE 
        WHEN r.reclutador_id = '5ff1169b-f725-4a8c-bc5d-0bead2c87afc' THEN '✅ TEFA'
        ELSE '❌ OTRO'
    END as es_tefa
FROM reclutamientos r
LEFT JOIN investigaciones i ON r.investigacion_id = i.id
