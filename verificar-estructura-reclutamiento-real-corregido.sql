-- ====================================
-- VERIFICAR ESTRUCTURA RECLUTAMIENTO REAL (CORREGIDO)
-- ====================================
...
SELECT 'Participantes externos:' as tabla, COUNT(*) as total FROM participantes
UNION ALL
...
-- PASO 6: Mostrar algunos participantes válidos (externos)
SELECT '=== PARTICIPANTES EXTERNOS VÁLIDOS ===' as info;
...
-- PASO 7: Mostrar algunos participantes válidos (internos)
SELECT '=== PARTICIPANTES INTERNOS VÁLIDOS ===' as info;
