-- Vista simplificada sin depender de participantes_internos
-- Solo mostrar investigaciones en estado pendiente
...
SELECT 
    ...
    CONCAT('0/', COALESCE(l.numero_participantes, 0)) AS progreso_reclutamiento,
...
WHERE i.estado = 'pendiente'  -- Solo investigaciones en estado pendiente
  AND i.id IS NOT NULL       -- Asegurar que es una investigación real
