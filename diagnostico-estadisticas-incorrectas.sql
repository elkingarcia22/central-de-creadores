-- ====================================
-- DIAGNÓSTICO DE ESTADÍSTICAS INCORRECTAS
-- ====================================
-- Problema: Las estadísticas muestran números incorrectos
-- - Solo 1 finalizada pero muestra 2 en empresa y 2 en participantes
-- - Al crear nueva suma 1 en empresa y 2 en participantes
...
SELECT '=== VERIFICANDO ESTADO ACTUAL COMPLETO ===' as info;
...
-- ====================================
-- 2. VERIFICAR DETALLES ESPECÍFICOS
-- ====================================
...
-- ====================================
-- 3. VERIFICAR DUPLICADOS EN HISTORIAL
-- ====================================

SELECT '=== VERIFICANDO DUPLICADOS EN HISTORIAL ===' as info;
...
-- ====================================
-- 4. VERIFICAR PARTICIPANTES ESPECÍFICOS
-- ====================================
...
-- ====================================
-- 5. VERIFICAR EMPRESAS ESPECÍFICAS
-- ====================================
...
-- ====================================
-- 6. VERIFICAR REGISTROS EN HISTORIAL
-- ====================================
...
SELECT '=== DIAGNÓSTICO DE ESTADÍSTICAS INCORRECTAS COMPLETADO ===' as info;
