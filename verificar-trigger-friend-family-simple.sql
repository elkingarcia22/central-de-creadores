-- =====================================================
-- VERIFICAR TRIGGER FRIEND AND FAMILY - SIMPLE
-- =====================================================

-- 1. DESHABILITAR TEMPORALMENTE EL TRIGGER
...
WHERE trigger_name LIKE '%reclutamientos%';
...
BEGIN
    ...
    -- Insertar reclutamiento SIN trigger
