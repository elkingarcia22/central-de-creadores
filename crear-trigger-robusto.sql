-- Crear trigger robusto que maneje todos los campos del API
    ...
    IF (TG_OP = 'INSERT' OR TG_OP = 'UPDATE') THEN
        ...
        IF NEW.participantes_id IS NOT NULL THEN
            ...
            IF NOT EXISTS (
                ...
                -- Insertar SOLO en historial de participantes (ROBUSTO)
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        RAISE LOG 'Error en trigger_participantes_solo: %', SQLERRM;
        RETURN NEW;
END;
$func$ LANGUAGE plpgsql;

-- 4. CREAR TRIGGER ROBUSTO
