...
async function sincronizarHistoricoExternosCorregido() {
  console.log('🔄 === SINCRONIZANDO HISTORIAL DE PARTICIPANTES EXTERNOS (CORREGIDO) ===\n');
...
sincronizarHistoricoExternosCorregido(); 