-- Script para poblar la tabla industrias con datos del archivo industrias_rows.sql
...
-- Ejecutamos el INSERT de las industrias
...
SELECT COUNT(*) as total_industrias_despues FROM industrias;

-- Mostramos algunas industrias para verificar
SELECT 'Primeras 10 industrias:' as mensaje;
SELECT id, nombre, activo FROM industrias LIMIT 10;

-- Verificamos que RLS esté deshabilitado
