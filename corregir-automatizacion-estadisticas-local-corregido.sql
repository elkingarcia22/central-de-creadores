-- ====================================
-- CORRECCIÓN DE AUTOMATIZACIÓN DE ESTADÍSTICAS (ENTORNO LOCAL) - CORREGIDO
-- ====================================
...
-- Solución: Script adaptado para entorno local sin asumir estructura de empresas
...
-- ====================================
-- 2. VERIFICAR ESTRUCTURA DE EMPRESAS
-- ====================================

SELECT '=== VERIFICANDO ESTRUCTURA DE EMPRESAS ===' as info;

-- Verificar si existe created_at en empresas
SELECT 
    CASE 
        WHEN EXISTS (SELECT 1 FROM information_schema.columns 
                    WHERE table_name = 'empresas' AND column_name = 'created_at') 
        THEN 'created_at existe'
        ELSE 'created_at NO existe'
    END as estado_created_at;

-- Verificar si existe creado_el en empresas
SELECT 
    CASE 
        WHEN EXISTS (SELECT 1 FROM information_schema.columns 
                    WHERE table_name = 'empresas' AND column_name = 'creado_el') 
        THEN 'creado_el existe'
        ELSE 'creado_el NO existe'
    END as estado_creado_el;

-- Verificar si existe activo en empresas
SELECT 
    CASE 
        WHEN EXISTS (SELECT 1 FROM information_schema.columns 
...
-- ====================================
-- 3. CREAR FUNCIÓN ADAPTADA PARA ENTORNO LOCAL
-- ====================================
...
-- ====================================
-- 4. CREAR FUNCIÓN PARA PARTICIPANTES EXTERNOS (LOCAL)
-- ====================================
...
-- ====================================
-- 5. CREAR TRIGGERS ADAPTADOS PARA LOCAL
-- ====================================
