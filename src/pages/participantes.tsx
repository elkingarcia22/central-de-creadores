      ...
      <div className="py-10 px-4">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="relative">
            ...
            {showDropdown && (
              <div 
                className="absolute right-0 top-14 w-48 bg-background border border-border rounded-lg shadow-lg z-50"
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 text-sm text-foreground hover:bg-accent transition-colors duration-200 first:rounded-t-lg"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 text-sm text-foreground hover:bg-accent transition-colors duration-200"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 text-sm text-foreground hover:bg-accent transition-colors duration-200 last:rounded-b-lg"
                >
