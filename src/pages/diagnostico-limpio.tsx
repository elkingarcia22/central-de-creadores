...
export default function DiagnosticoLimpio() {
  ...
  useEffect(() => {
    console.log('🔍 DiagnosticoLimpio - useEffect inicialización');
    setIsClient(true);
  ...
  useEffect(() => {
    if (isClient) {
      console.log('🔍 DiagnosticoLimpio - Componente renderizado #', renderCount + 1);
    ...
    <Layout rol="administrador">
      <div className="py-10 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-2xl font-bold mb-4">Diagnóstico Limpio</h1>
