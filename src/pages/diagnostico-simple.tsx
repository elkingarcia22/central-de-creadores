...
export default function DiagnosticoSimple() {
  ...
  useEffect(() => {
    console.log('🔍 DiagnosticoSimple - useEffect inicialización');
    setIsClient(true);
  ...
  useEffect(() => {
    if (isClient) {
      console.log('🔍 DiagnosticoSimple - Componente renderizado #', renderCount + 1);
    ...
    <Layout rol="administrador">
      <div className="py-10 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-2xl font-bold mb-4">Diagnóstico Simple</h1>
