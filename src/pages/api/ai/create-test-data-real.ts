...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    console.log('🧪 [Test Data Real] Creando datos de prueba con participantes reales...');
...
Participante: Sí, me gustaría que el proceso fuera más visual. Tal vez con un editor más tipo drag-and-drop. También me gustaría poder guardar plantillas de encuestas que uso frecuentemente.`,
    ...
    // 2. Crear notas manuales con participantes reales
    const notasProducto = [
      {
    ...
    console.log('📝 [Test Data Real] Insertando datos...');
    ...
    if (errors.length > 0) {
      console.error('❌ [Test Data Real] Errores al insertar:', errors);
    ...
    console.log('✅ [Test Data Real] Datos de prueba creados exitosamente');

    return res.status(200).json({
      status: 'ok',
      message: 'Datos de prueba creados exitosamente con participantes reales',
      datos: [
        {
          tipo: 'transcripcion',
          id: '12345678-1234-1234-1234-123456789101',
    ...
    console.error('❌ [Test Data Real] Error:', error);
    return res.status(500).json({ 
      error: 'Error al crear datos de prueba',
