...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div 
      className={`flex flex-col flex-grow bg-black border-r border-zinc-700 h-screen min-h-0 transition-all duration-300 ease-out ${isExpanded ? 'w-64' : 'w-16'} z-50 overflow-hidden ${className}`}
