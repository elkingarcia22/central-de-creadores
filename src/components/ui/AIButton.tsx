...
export const AIButton: React.FC<AIButtonProps> = ({ 
  ...
  const variantClasses = "bg-transparent border border-blue-600 text-blue-600 hover:text-blue-700 hover:border-blue-700";
      ...
      <div className="relative">
        {loading ? (
          ...
          <>
            ...
            <div className={`absolute inset-0 ${iconSizeClass} bg-blue-500/20 rounded-full blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
          </>
        )}
      </div>
