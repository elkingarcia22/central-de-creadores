      ...
      <Card className="p-4 bg-muted/30">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            {/* Botón Re-analizar - siempre visible, estilo secundario mejorado */}
            {onReanalyze && (
              <button
                onClick={onReanalyze}
              ...
              >
                ...
                <div className="relative">
                  <RefreshIcon className="w-3 h-3 text-blue-600 dark:text-blue-400 group-hover:text-white transition-colors duration-300" />
