-- ====================================
-- VERIFICAR Y CREAR DEPARTAMENTOS COMPLETO - CORREGIDO
-- ====================================
-- Ejecutar en el SQL Editor de Supabase
-- Este script verifica y crea todo lo necesario sin errores
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_participantes_internos_departamento') THEN
        ...
        RAISE NOTICE 'Foreign key fk_participantes_internos_departamento creado.';
    ELSE
        RAISE NOTICE 'Foreign key fk_participantes_internos_departamento ya existe.';
    END IF;
END
$$;
