-- ====================================
-- ACTUALIZAR EMPRESAS CON DATOS REALES
-- ====================================

-- 1. VERIFICAR DATOS REALES EN TABLAS
SELECT '=== DATOS REALES EN estado_empresa ===' as info;
SELECT id, nombre FROM estado_empresa ORDER BY nombre;

SELECT '=== DATOS REALES EN relacion_empresa ===' as info;
SELECT id, nombre FROM relacion_empresa ORDER BY nombre;

-- 2. ACTUALIZAR EMPRESAS CON VALORES QUE SÍ EXISTEN
...
SELECT '✅ Empresas actualizadas con datos reales existentes' as resultado; 