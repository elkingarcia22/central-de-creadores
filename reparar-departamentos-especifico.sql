-- ====================================
-- REPARAR DEPARTAMENTOS - SCRIPT ESPECÍFICO
-- ====================================
-- Ejecutar en el SQL Editor de Supabase
-- Este script arregla específicamente el problema de la columna departamento
...
SELECT '✅ Departamentos insertados (solo nuevos)' as resultado;

-- PASO 4: Agregar columna departamento_id a participantes_internos
SELECT 'PASO 4: Agregando columna departamento_id...' as info;

-- Verificar si ya existe la columna
SELECT '¿Existe columna departamento_id?' as pregunta;
SELECT EXISTS (
...
SELECT '✅ Columna departamento_id agregada' as resultado;

-- PASO 5: Migrar datos existentes
SELECT 'PASO 5: Migrando datos existentes...' as info;

-- Mostrar datos actuales
SELECT 'Datos actuales en participantes_internos:' as info;
SELECT id, nombre, email, departamento, departamento_id
...
SELECT 
    ...
    pi.nombre,
    pi.email,
    pi.departamento as departamento_old,
    d.nombre as departamento_new,
...
-- Contadores finales
SELECT 'Contadores finales:' as info;
SELECT 
...
SELECT '🎉 REPARACIÓN DE DEPARTAMENTOS COMPLETADA' as resultado_final; 