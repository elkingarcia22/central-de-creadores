-- ====================================
-- VERIFICAR ESTADO ACTUAL ESTADÍSTICAS (CORREGIDO)
-- ====================================
...
-- ====================================
-- 6. VERIFICAR ÚLTIMOS RECLUTAMIENTOS (SIN CREATED_AT)
-- ====================================
...
-- ====================================
-- 7. VERIFICAR ESTRUCTURA TABLA RECLUTAMIENTOS
-- ====================================
...
-- ====================================
-- 8. VERIFICAR ESTADO DE AGENDAMIENTO
-- ====================================
...
-- ====================================
-- 9. VERIFICAR RECLUTAMIENTOS CON ESTADO FINALIZADO
-- ====================================

SELECT 
    '=== RECLUTAMIENTOS CON ESTADO FINALIZADO ===' as info;
...
LEFT JOIN participantes p ON r.participantes_id = p.id
LEFT JOIN estado_agendamiento_cat eac ON r.estado_agendamiento = eac.id
WHERE r.estado_agendamiento = (SELECT id FROM estado_agendamiento_cat WHERE nombre = 'Finalizado')
ORDER BY r.id DESC;
