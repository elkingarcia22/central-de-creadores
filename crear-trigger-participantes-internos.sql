-- Crear trigger para participantes internos (sin empresa)
...
-- 3. CREAR FUNCIÓN PARA PARTICIPANTES INTERNOS
...
BEGIN
    ...
    IF (TG_OP = 'INSERT' OR TG_OP = 'UPDATE') THEN
        ...
        IF NEW.participantes_internos_id IS NOT NULL THEN
            -- Verificar si ya existe en historial de participantes internos
            IF NOT EXISTS (
                ...
                -- Insertar SOLO en historial de participantes internos
...
-- 4. CREAR TRIGGER PARA PARTICIPANTES INTERNOS
