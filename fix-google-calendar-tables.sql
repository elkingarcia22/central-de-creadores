-- ====================================
-- CORRECCIÓN DE TABLAS GOOGLE CALENDAR
-- ====================================
...
CREATE INDEX idx_google_calendar_events_sesion_id ON google_calendar_events(sesion_id);
CREATE INDEX idx_google_calendar_events_google_event_id ON google_calendar_events(google_event_id);
