-- ====================================
-- SISTEMA DE LOG DE ACTIVIDADES DE INVESTIGACIONES (VERSIÓN CORREGIDA)
-- ====================================
...
-- Trigger para creación de seguimientos (solo si la tabla existe)
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'seguimientos_investigacion') THEN
