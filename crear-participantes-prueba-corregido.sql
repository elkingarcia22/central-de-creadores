-- ====================================
-- CREAR PARTICIPANTES DE PRUEBA (CORREGIDO)
-- ====================================
...
BEGIN
    ...
    SELECT id INTO dep_id_rh FROM departamentos WHERE nombre = 'Dirección de Recursos Humanos' LIMIT 1;
    SELECT id INTO dep_id_dev FROM departamentos WHERE nombre = 'Dirección de Tecnología' LIMIT 1;
    SELECT id INTO dep_id_mkt FROM departamentos WHERE nombre = 'Dirección de Marketing' LIMIT 1;
    SELECT id INTO dep_id_ventas FROM departamentos WHERE nombre = 'Dirección Comercial' LIMIT 1;
    ...
    -- Insertar participantes de prueba (usando nombres de columnas correctos)
    INSERT INTO participantes_internos (nombre, email, departamento_id, activo, created_at, updated_at) VALUES
