-- ====================================
-- CORRECCIÓN DE ESTADÍSTICAS - LIMPIEZA COMPLETA (CORREGIDO)
-- ====================================
...
-- Mostrar los reclutamientos finalizados (sin asumir created_at)
SELECT 
...
-- ====================================
-- 9. VERIFICAR CORRESPONDENCIA FINAL
-- ====================================

SELECT '=== VERIFICACIÓN FINAL ===' as info;

-- Verificar que el historial coincide con los finalizados
SELECT 
    'Correspondencia final' as info,
