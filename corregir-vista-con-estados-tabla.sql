-- ====================================
-- CORREGIR VISTA CON ESTADOS DE TABLA
-- ====================================
...
-- 3. Crear la nueva vista con estado calculado por progreso usando la tabla
...
SELECT '✅ Vista vista_reclutamientos_completa creada con estados de tabla' as status;

-- 5. Probar la vista
SELECT '=== PRUEBA DE LA VISTA CON ESTADOS DE TABLA ===' as info;
