-- Crear trigger final correcto

-- 1. LIMPIAR TRIGGERS DE PRUEBA
DROP TRIGGER IF EXISTS trigger_basico ON reclutamientos;
DROP TRIGGER IF EXISTS trigger_debug ON reclutamientos;
...
-- 2. CREAR TRIGGER FINAL CORRECTO
...
-- 4. VERIFICAR TRIGGER FINAL
SELECT 
  'TRIGGER FINAL CREADO' as fuente,
  trigger_name,
  event_manipulation,
  action_timing
FROM information_schema.triggers 
WHERE trigger_name = 'trigger_estadisticas_final'; 