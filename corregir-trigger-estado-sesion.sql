-- Corregir trigger con estado_sesion NULL
...
-- 3. CREAR FUNCIÓN CORREGIDA CON ESTADO_SESION NULL
    ...
    IF (TG_OP = 'INSERT' OR TG_OP = 'UPDATE') THEN
        ...
        IF NEW.participantes_id IS NOT NULL THEN
            ...
            IF NOT EXISTS (
                ...
                -- Insertar SOLO en historial de participantes (CON ESTADO_SESION NULL)
