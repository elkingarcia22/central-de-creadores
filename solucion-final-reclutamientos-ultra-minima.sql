-- ====================================
-- SOLUCIÓN FINAL RECLUTAMIENTOS - VISTA ULTRA MÍNIMA
-- ====================================
...
-- 2. Crear vista ultra-mínima usando solo columnas básicas
...
SELECT 
    ...
    -- Datos de investigación (solo id por ahora)
    i.id as investigacion_id_completo,
