-- Probar trigger con investigacion_id válido
...
-- 2. CREAR NUEVO RECLUTAMIENTO DE PRUEBA (CON INVESTIGACION_ID)
...
-- 6. VERIFICAR QUE EL TRIGGER FUNCIONÓ
SELECT 
  'VERIFICAR TRIGGER' as fuente,
