-- ====================================
-- TRIGGER CORREGIDO PARA CREAR RECLUTAMIENTOS AUTOMÁTICAMENTE
-- ====================================
...
-- Ver algunos participantes de ejemplo
...
-- ====================================
-- OPCIONES PARA MANEJAR LA RESTRICCIÓN
-- ====================================

-- Opción 1: Crear un participante por defecto si no existe ninguno
DO $$
DECLARE
...
-- Opción 2: Crear un estado de agendamiento por defecto si no existe ninguno
DO $$
DECLARE
...
-- Función corregida que maneja las restricciones de clave foránea
CREATE OR REPLACE FUNCTION crear_reclutamiento_por_agendar_corregido()
RETURNS TRIGGER AS $$
DECLARE
    usuario_actual uuid;
    participante_default_id uuid;
...
CREATE TRIGGER trigger_crear_reclutamiento_por_agendar
    ...
    FOR EACH ROW
    EXECUTE FUNCTION crear_reclutamiento_por_agendar_corregido();
